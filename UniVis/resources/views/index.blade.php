                ...
                <ol class="step pl-0">
                    ...
                    <li class="step-element pb-0">
                        ...
                        <div class="step-excerpt">
                            ...
                            <p class="text-muted">Once you're in the page you've been brought to, you will see a search tool. This is where you can find all the information you need using that search bar.</p>
                        </div>
                    </li>
                </ol>
                ...
                <div class="col-lg-12 ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            ...
                            <p class="grey-text">In this project, we used bootstrap to style our website and also neoj4 for database.</p>
                        </div>
                    </div>
                    <!--/First row-->
