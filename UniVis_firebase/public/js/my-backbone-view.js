define(['jquery', 'backbone', 'myModel', 'forceView'], function($, Backbone, MyModel, ForceView) {
    ...
    return Backbone.View.extend({
        ...
        events: {
            ...
            'click button.remove-nodes': 'removeNode',
            'click #editNodeModal button.btn.btn-primary': 'editNode',
            'click #editNodeModal button.btn.btn-danger': 'removeNode',
            'change #textNode': 'textChanged',
            'change #textCategoryNode': 'categoryChanged'
        },
        ...
        categoryChanged: function() {
            this.model.set('category', this.$el.find('#textCategoryNode').val(), { silent: true });
        },
        ...
        removeNode: function() {
            this.mediatorChannel.trigger('remove-node', {
                id: this.model.get('id')
            });
            this.hideModal();
        },
        ...
        sync: function() {
            ...
            view.model.on('change:category', function(model, category) {
                view.$el.find('#textCategoryNode').val(category);
            });
