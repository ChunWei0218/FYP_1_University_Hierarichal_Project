...
<div class="view" style="background-image: url('https://mdbootstrap.com/img/Photos/Others/images/93.jpg'); background-repeat: no-repeat; background-size: cover;">
    ...
    <div class="mask rgba-black-light d-flex justify-content-center align-items-center">
        ...
        <div class="text-center white-text mx-5 wow fadeIn">
            ...
            <p>
                <strong>We provide the all the information you need about Universities related data including the departments, projects and also employee. </strong>
            </p>

            <a href="<?php echo e(route('university')); ?>" class="btn btn-outline-white btn-lg">Search
            </a>
        </div>
        <!-- Content -->
                ...
                <ol class="step pl-0">
                    ...
                    <li class="step-element pb-0">
                        ...
                        <div class="step-excerpt">
                            ...
                            <p class="text-muted">Once you're in the page you've been brought to. This is where you can find the information that you want to get in contact with using that search bar.</p>
                        </div>
                    </li>
                </ol>
                ...
                <div class="col-lg-12 ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            ...
                            <p class="grey-text">In this project, we mainly used Laravel and also Firebase to operate this website and database.</p>
                        </div>
                    </div>
                    <!--/First row-->
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\bhsc1\OneDrive\Desktop\UniVis_firebase\resources\views/index.blade.php ENDPATH**/ ?>