                ...
                <section>
                    ...
                    <div class="row text-center text-md-left">
                        <div class="col-md-6 mb-4">
                            <h5 class="font-weight-normal mb-3">How to use this toolkit?</h5>
                            <p class="text-muted">The toolkit that we provide allows you to search for information about universities related information such as Universities, Departments, Projects and also Employees.</p>
                        </div>

                        <div class="col-md-6 mb-4">
                            <h5 class="font-weight-normal mb-3">Why can't I create and account in this site?</h5>
                            <p class="text-muted">The account only can be given to universities that have collaborated with us. This is because having account will gain access to modify the information in the database.</p>
                        </div>

                        <div class="col-md-6 mb-4">
                            <h5 class="font-weight-normal mb-3">Does this site provides the lastest information?</h5>
                        ...
                        <div class="col-md-6 mb-4">
                            <h5 class="font-weight-normal mb-3">Why can't I sign in?</h5>
...
<?php echo $__env->make('layouts.layout_2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\bhsc1\OneDrive\Desktop\UniVis_firebase\resources\views/faq.blade.php ENDPATH**/ ?>